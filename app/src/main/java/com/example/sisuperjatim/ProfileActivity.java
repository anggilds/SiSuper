...
public class ProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        kab_kota = findViewById(R.id.kabupaten);
        desa = findViewById(R.id.desa);
        kecamatan = findViewById(R.id.kecamatan);
        koordinat = findViewById(R.id.mapinput);
        jenis_lahan = findViewById(R.id.jenis_lahan);
        bahan_induk = findViewById(R.id.bahan_induk);
        penggunaan_lahan = findViewById(R.id.bahan_induk);
        relief = findViewById(R.id.bahan_induk);
        kondisi_lahan = findViewById(R.id.kondisi_lahan);
        drainase = findViewById(R.id.drainase);
        reaksi_tanah = findViewById(R.id.reaksi_tanah);
        tanaman_utama = findViewById(R.id.tanaman_utama);
        tekstur = findViewById(R.id.tekstur);
        kedalaman_olah = findViewById(R.id.kedalaman_olah);
        pola_tanaman = findViewById(R.id.pola_tanam);
        varietas = findViewById(R.id.varietas);
        provitas = findViewById(R.id.provitas);
        penggunaan_pupuk = findViewById(R.id.penggunaan_pupuk);
